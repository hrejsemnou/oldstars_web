...
const Home = () => (
  ...
  <p>HarOLD - sklepní prostor v Charkovské: Charkovská 15, Praha 10</p>
    ...
    <p>
      <strong>Produkce projektů: </strong>Elisa Speváková, <a href="mailto:elisa.spevakova@oldstars.cz">elisa.spevakova@oldstars.cz</a>, </strong>Jiří Dejl, <a href="mailto:jiri.dejl@oldstars.cz">jiri.dejl@oldstars.cz</a>
    </p>
    <p>
