...
const Home = () => (
  <Layout title="OLDstars > Projekty > OLDstars on the ROAD">
    ...
    <p> Projekt OLDstars on the ROAD 2022 byl podpořen grantem Státního fondu kultury, grantem měst Kutná Hora a Roudnice nad Labem a grantem Středočeského kraje - děkujeme!</p> 
    ...
    <p>
      Letní divadelní festival si pochopitelně žádá celou řadu příprav. Účastníci příměstského tábora tak budou mít jedinečnou možnost začlenit se do tvorby festivalu od samého začátku. Každý den přípravného týdne (4.-8. 7. 2022) je pro ně připraven jeden ateliér, který jim umožní nahlédnout na přípravy festivalu optikou nejrůznějších divadelních profesí. Těšit se tak mohou například na seznámení s výkonnou produkcí, propagací a PR, tvůrčím psaním nebo ovládáním divadelní techniky. Dále se zúčastní vybraných divadelních zkoušek a samozřejmě si uměleckou práci vyzkouší na vlastní kůži. Předchozí zkušenost s divadlem není nutná. 
    </p>
    <p>
      Podrobnější informace a přihlášky na e-mailové adrese festival@oldstars.cz. Součástí workshopů i příměstského tábora je festivalová permanentka. Tábor je primárně určen pro účastníky ve věku 13-17 let.
    </p>
    <p>
